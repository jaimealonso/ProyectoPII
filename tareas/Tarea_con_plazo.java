...
public class Tarea_con_plazo extends Tarea{
	...
	/**
	 * M�todo que devuelve un String que represente la fecha de plazo.
	...
	/**
	 * M�todo que devuelve un String que represente la fecha de plazo de forma compacta.
	...
	/**
	 * M�todo que permite saber los d�as que quedan para el plazo de la tarea.
	 * @return El n�mero de d�as que quedan hasta el plazo.
	 */
	public int getDias(){
	...
	//M�TODOS TOSTRING SOBREESCRITOS
	...
	/**
	 * M�todo que permite determinar si la fecha de la tarea est� en el futuro.
	...
	@Override
	/**
	 * M�todo equals sobreescrito para la tarea con plazo.
	 */
